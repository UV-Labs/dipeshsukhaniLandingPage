            ...
            <div className="item md-mb50">
              ...
              <ul>
                ...
                <li>
                  ...
                  <div className="cont">
                    <h6><a rel="noreferrer" target="_blank" href="https://t.me/dipesh_dev">Telegram</a></h6>
                    {/* <p>Click here</p> */}
                  </div>
                </li>
          ...
          <div className="col-lg-4">
            <div className="item">
              ...
              <div className="social">
                <a target="_blank" rel="noreferrer" href="https://github.com/amateur-dev">
                  <i className="fab fa-github"></i>
                </a>
                <a target="_blank" rel="noreferrer" href="https://twitter.com/amateurdev2">
                  <i className="fab fa-twitter"></i>
                </a>
                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/dipeshsukhani/">
                  <i className="fab fa-linkedin"></i>
                </a>
                <a target="_blank" rel="noreferrer" href="mailto:me@dipeshsukhani.dev?subject=Subject">
                <i className="fab fa-google"></i>
                </a>
                <a target="_blank" rel="noreferrer" href="https://t.me/dipesh_dev">
