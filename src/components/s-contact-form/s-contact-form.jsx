        ...
        <div className="row">
          <div className="col-lg-4 valign md-mb50">
            <div className="sec-head mb-0">
              ...
              <h3 className="wow mb-20 color-font">Let’s Get in Touch.</h3>
          ...
          <div className="col-lg-8" style={{display: "flex",justifyContent: "space-evenly"}}>
            <div>
              ...
              <button
                            ...
                            >
                              <span style={{letterSpacing: '1px', fontSize: '30px'}}><a target="_blank" rel="noreferrer" href="https://bit.ly/dkdevcalender" title="" download>Block a Call</a></span>
                            </button>
              </div>
              <div className="row">
